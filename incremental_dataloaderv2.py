        ...
        for dataset in datasets:
            if (self.dataset_name == "imagenet"):
                ...
                test_dataset = dataset.base_dataset(root=path, split='val', download=False, transform=trsf_test)
                    ...
                    self.dataset_name == "cub200" or self.dataset_name == "cifar10" or self.dataset_name == "cifar10poison" or self.dataset_name == "cifar100" or self.dataset_name == "mnist" or self.dataset_name == "caltech101" or self.dataset_name == "omniglot" or self.dataset_name == "celeb"):
...
class iCIFAR10Poison(DataHandler):
    base_dataset = datasets.cifar.CIFAR10Poison
    train_transforms = [
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.RandomRotation(10),
